      ...
      <ScrollView className = 'px-4 my-6'>
        ...
        <View className = 'mt-7 space-y-2'>
          ...
          <TouchableOpacity onPress={()=>openPicker('video')}>
            ...
            (
              <View className = 'w-full h-40 px-4 bg-black-100 rounded-2xl justify-center items-center'>
                <View className = 'w-14 h-14 boder border-dashed border-secondary-100 justify-center items-center'>
                  <Image
                  source={icons.upload}
                  resizeMode='contain'
          ...
          <TouchableOpacity onPress={()=>openPicker('image')}>
            ...
            :
            (
              <View className = 'w-full h-16 px-4 bg-black-200 rounded-2xl justify-center items-center flex-row space-x-2'>
